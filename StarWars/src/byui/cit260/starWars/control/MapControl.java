...
public class MapControl {
    ...
    public static void moveEnemyFighterToLocation(EnemyFighter enemyFighter, Point coordinates) throws MapControlException {
        ...
        if (newRow < 0 || newRow >= map.getNoOfRows() || newColumn < 0
            ...
            throw new MapControlException("Can not move enemy fighter to location "
