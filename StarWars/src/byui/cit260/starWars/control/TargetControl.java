...
public class TargetControl {
    ...
    // Added by Edvaldo Melo
    public double getTotalPriceOfItem() {
        
        Scanner inFile = new Scanner(System.in);
        
        // get the price of the item entered by the end user
        String priceAsString = inFile.next();
        
        // convert price ftom String to a fouble value
        double priceAsDouble = Double.parseDouble(priceAsString);
        
        // add tax to the price
        double total = priceAsDouble + priceAsDouble * 0.7;
